...
export default function Home({ publication, recentPosts }: Props) {
	...
	const siteDescription = publication.descriptionSEO || 'Senior Front-End Developer with 15+ years of experience building scalable, high-performance web apps and company websites. Skilled in React, Next.js, TypeScript, and Tailwind CSS with a strong focus on accessibility, SEO, and client success.';
